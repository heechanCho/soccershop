...
import com.soccerSite.soccershop.entity.Item;
import com.soccerSite.soccershop.entity.QItem;
...
class ItemRepositoryTest {
    ...
    public void findByPriceTest() {
        this.createItemList();
        List<Item> itemList = itemRepository.findByPrice(10010);
        for (Item item : itemList) {
            System.out.println(item.toString());
        }
    }
    ...
    public void findByItemNmOrItemDetailTest() {
        this.createItemList();
        List<Item> itemList = itemRepository.findByItemNmOrItemDetail("테스트상품 10", "테스트 상품 상세 설명5");
        for (Item item : itemList) {
            System.out.println(item.toString());
        }
    }
